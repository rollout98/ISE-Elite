...
{
    public sealed class NewYorkStructuralEntryResearchTests
    {
        [Fact]
        public void Continue_RequiresMultiBarSwingResumption()
        {
            ...
            var bars = BuildBars(date, new[]
            {
                ...
                (8,45,131m,134m,130m,133m),(8,46,133m,136m,132m,135m),(8,47,135m,137m,128m,130m),(8,48,130m,133m,129m,132m),
            ...
            Assert.Equal(NewYorkStructuralEntryDisposition.EntryQualified, outcome.Disposition);
            Assert.Equal(bars[20].TimestampUtc, outcome.SetupCompleteUtc);
            Assert.Equal(bars[21].TimestampUtc, outcome.EntryUtc);
        }

        [Fact]
        public void Continue_InvalidatesWhenOpeningMidpointFails()
        {
            ...
            var bars = BuildBars(date, new[]
            {
                ...
                (8,45,143m,146m,142m,145m),(8,46,145m,147m,143m,146m),(8,47,146m,146m,118m,120m),(8,48,120m,123m,117m,119m)
            });
            var transition = new NewYorkEightFortyFiveTransitionOutcome(date, NewYorkEightFortyFiveState.Continue,
                NewYorkResearchDirection.Long, NewYorkResearchDirection.Long, bars[15].TimestampUtc, bars[16].TimestampUtc,
        ...
        [Fact]
        public void Reverse_RetainsCompletedBarConfirmation()
        {
            var date = new DateTime(2026, 7, 16);
            var bars = BuildBars(date, new[]
            {
                (8,30,100m,102m,99m,101m),(8,31,101m,103m,100m,102m),(8,32,102m,104m,101m,103m),(8,33,103m,105m,102m,104m),
                (8,34,104m,106m,103m,105m),(8,35,105m,107m,104m,106m),(8,36,106m,108m,105m,107m),(8,37,107m,109m,106m,108m),
                (8,38,108m,110m,107m,109m),(8,39,109m,111m,108m,110m),(8,40,110m,112m,109m,111m),(8,41,111m,113m,110m,112m),
                (8,42,112m,114m,111m,113m),(8,43,113m,115m,112m,114m),(8,44,114m,116m,113m,115m),
                (8,50,110m,111m,106m,107m),(8,51,107m,108m,101m,102m),(8,52,102m,103m,96m,97m),(8,53,97m,99m,94m,96m)
            });
