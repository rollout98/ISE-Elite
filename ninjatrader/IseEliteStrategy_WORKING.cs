...
{
	public class IseEliteStrategyWorking : NinjaTrader.Strategy.Strategy
	{
		private double sma5;
		...
		protected override void OnStateChange()
		{
			...
			{
				Description									= @"ISE Elite - Production Ready";
				Name										= "IseEliteStrategyWorking";
		...
		protected override void OnBarUpdate()
		{
			...
			if (Time[0].Date != lastTradeDay)
			{
				...
				openingEquity = Account.Get(NinjaTrader.Cbi.AccountItem.CashValue, NinjaTrader.Cbi.Currency.UsDollar);
				dailyPnL = 0;
				tradesThisDay = 0;
			...
			if (hour == 15 && minute == 0)
			{
				double closingEquity = Account.Get(NinjaTrader.Cbi.AccountItem.CashValue, NinjaTrader.Cbi.Currency.UsDollar);
